...
| 0004 | ops | in_arbeit | 0.4.1 | Betrieb: EINE Vorgangs-Engine (Status-Flow/Plantafel-DnD/Verlauf/Zuweisung/Eskalation) + 5 Typ-Erweiterungen, Träger akteure (Mensch+KI); Foto-UI + KI-Bildverarbeitung (Claude Vision: Zähler/Vorher-Nachher-Abgleich) + Schaden-Übernahme; Vorgänge aus Kern ausgelagert |
