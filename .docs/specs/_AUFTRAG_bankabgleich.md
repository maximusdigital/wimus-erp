# Auftrag Claude Code: Bank-Abgleich bauen (FiBu 0002)
...
- **K1 = Objekt-Kürzel.** K1 (IS17/ThS97/AS125…) ist bereits die Objekt-Kennung im System
  ...
  Der Bank-Abgleich matcht gegen K1. → Ermittle, wie K1 real auf objekt/einheit aufgelöst wird
  (Tabelle/Mapping vs. TEXT-Feld) und nutze diesen Weg. Falls es noch keine saubere
  K1→objekt/einheit-Auflösung gibt, im Report als Rückfrage melden (nicht raten).
