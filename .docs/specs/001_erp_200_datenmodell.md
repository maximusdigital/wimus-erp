...
### Feld-Edit-Stufen (steuert auch Inline-Edit, s. Abschnitt „UI-Konventionen" in `001_erp_400_design.md`)
...
- Träger ist das Akteure-Modell (0001). Anzeige als Timeline in der Detailansicht
  (Abschnitt „UI-Konventionen" in `001_erp_400_design.md` Punkt 8).
