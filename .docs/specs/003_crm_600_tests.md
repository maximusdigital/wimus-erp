...
> Test-Stack siehe Kern 0001 `001_erp_600_tests.md` (Vitest, Playwright, supertest, pgTAP).
>
> **Umgesetzt (2026-06-27):** Priorität-1-Kernlogik als Unit-Tests in
> `tests/unit/lib/crm.test.ts` (14 Tests, grün): Stage-Übergang + Verweildauer + Sperre bei
> Abschluss, Stalled, Lead verwerfen/konvertieren (firma_id-Pflicht, Re-Konvertierung
> gesperrt, Organisation durchgereicht), Forecast (Wert × Wahrscheinlichkeit), Pflicht- und
> Sichtbarkeits-Regeln der Custom-Fields (inkl. Pipeline-Scope). Offen: DB/pgTAP-RLS-Tests,
> E2E-Happy-Path, amoCRM-Mapping-Test.
