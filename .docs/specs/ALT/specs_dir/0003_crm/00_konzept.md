...
- Stage-Automatik-Mechanik im Kern vorhanden (Channel-Routing 3.2) — wartet auf das
  Pipeline-Datenmodell darunter.
- amoCRM (TB24) aktuell produktiv — wird durch dieses Modul abgelöst.

## In Arbeit

- Grobspec (dieses Modul)
...
- ~~OP-6: Kern-Erweiterung organisationen~~ → **erledigt 2026-06-26**: `organisationen` +
  `kontakte.organisation_id` in `0001/20_datenmodell.md` spezifiziert. Migration im Repo
  noch einzuspielen (0001 OP-4).
