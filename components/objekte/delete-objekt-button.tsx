...
export function DeleteObjektButton({
  id,
  kuerzel,
}: {
  id: string
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Objekt <strong>{kuerzel}</strong> wird dauerhaft gelöscht. Verknüpfte
            Einheiten und Daten gehen verloren. Das kann nicht rückgängig gemacht
            werden.
          </DialogDescription>
        </DialogHeader>
