...
export function DeleteMahnungButton({
  id,
  label,
}: {
  id: string
  ...
  async function onDelete() {
    ...
    setOpen(false)
    router.push("/finanzen/mahnungen")
    router.refresh()
  }
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Mahnung löschen?</DialogTitle>
          <DialogDescription>
            Mahnung <strong>{label}</strong> wird dauerhaft gelöscht. Das kann
