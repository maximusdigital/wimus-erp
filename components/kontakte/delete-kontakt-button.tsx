...
export function DeleteKontaktButton({
  id,
  name,
}: {
  id: string
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Kontakt <strong>{name}</strong> wird dauerhaft gelöscht. Verknüpfte
            Verträge verlieren ihre Zuordnung. Das kann nicht rückgängig gemacht
            werden.
          </DialogDescription>
        </DialogHeader>
